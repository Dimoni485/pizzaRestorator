...
echo "</td>";
echo "<td>";
echo "<a onclick='javascript:korrektsklad(\"".$Row['ID']."\",\"".$Row['KOLVO']."\");return(false);' href='#'><img src='pen.png' width='25px' height='25px' alt='Удалить'></a>";	
echo "</td>";
echo "<td>";
echo "<a onclick='javascript:spisanie(\"".$Row['ID']."\",\"".$Row['PRODUKT']."\",\"".$Row['ED_IZ']."\");return false;' href='#'><img src='garbage.png' width='25px' height='25px' alt='Списание'></a>";	
echo "</td>";
echo "<td>";
echo "<a href='#' onclick='javascript:delsklad(\"".$Row['ID']."\");return(false);' ><img src='error.png' width='25px' height='25px' alt='Удалить'></a>";	
echo "</td>";
