...
<a href="#" class="green" id="singh" onclick="javascript:rascetvsego();">Перерасчет всего...</a>
...
<br>
<br>
<a href="#" class="green" id="singh" onclick="javascript:deletvsego();return(true);">Удалить данные за </a>
<select class="data_pok">
<?php 
$date_prod=ibase_query("SELECT DATE_POK FROM PRODAZI GROUP BY DATE_POK");
while ($rowdateprod=ibase_fetch_assoc($date_prod)){
