...
?>
&nbsp;&nbsp;<a href="javascript:setperiod();"><img width="25px" src="tool.png"></a> 
&nbsp;<a href="javascript:(print());"><img width="25px" src="technology-1.png"></a><br> 
...
?>
	<th><a href="#" onclick='javascript:loadprodazi();'><img src="coins.png" width="35px"><b>ВЫРУЧКА</b></a></th>
	<td>
	<?php 
	if (isset($viruc)){
	...
	<th ><a href="#" title="(((1500*12)/365)+ВЫРУЧКА * 0.02)*2"><img src="girl.png" width="35px"><b>ФЗП АДМИНИСТРАТОРА</b></a></th>
...
<tr>
	<th ><a href="#" onclick='javascript:loadprodukt();'><img src="apple.png" width="35px"><b>СЕБЕСТОИМОСТЬ<br>реализованного товара</b></a></th>
	<td>
	<?php 
	...
	<th><a href="#" title="ВЫРУЧКА*0.20"><img src="food.png" width="35px"><b>ФЗП  ПОВАРОВ</b></a></th>
...
<tr>
	<th><a href="#" title="ДОСТАВКА=80р." onclick='javascript:loadrekvizit();'><img src="people.png" width="35px"><b>ДОСТАВКА</b></a></th>
	...
	<th><a href="#" onclick='javascript:loadspisanie();'><img src="garbage.png" width="35px"><b>СПИСАНИЕ</b></a></th>
	<td>
	<?php 
...
<tr>
	<th ><a href="#" onclick='javascript:loadskidka();'><img src="signs.png" width="35px"><b>СКИДКИ</b></a></th>
	<td>
	<?php 
	...
	<th><a href="#"><img src="money-1.png" width="35px"><b>ДОХОД</b></a></th>
	<td>
	<?php 
