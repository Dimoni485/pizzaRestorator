...
if ($dostavka[0] > 0){
	echo "+ доставка ".$dostavka[0]."р. <a class='dos_but' title='Убрать доставку' href='#' onclick='javascript:deldostavka(\"".$Row['ID']."\");return false;'><img src='rem_dos.png'></a>";
}else{
	echo "<a class='dos_but' href='#' title='Добавить доставку' onclick='javascript:addostavka(\"".$Row['ID']."\",\"".$Row['DATE_POK']."\");return false;'><img src='add_dos.png'></a>";
}
}
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo "<a href='#' onclick='vozvrat(\"".$Row['PRODUKT']."\",\"".$Row['COLVO']."\",\"".$Row['ID']."\");return(false);'><img src='vozvrat.png' white='20px' height=20px></a>";	
echo "</td>";
echo "</tr>";
