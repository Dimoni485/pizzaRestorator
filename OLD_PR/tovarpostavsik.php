...
ibase_close ($dbh);
?>
</select> <a href="#" id="filter_b" class="">Фильтр</a>
</div>
...
echo "Дата поставки: ".date('d.m.Y', strtotime($Row_produkt_date['DATA_POS']));
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo "<a onclick='javascript:deltovarp(".$Row['ID'].");return(false);' href='#'><img src='error.png' width='25px' height='25px' alt='Удалить'></a>";
echo "</td>";
echo "</tr>";
}
}
