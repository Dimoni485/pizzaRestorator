...
echo  '<a href="javascript:getsostav(\''.$Row['PRODUKT'].'\',\''.$nacenka.'\',\''.$Row['CENA'].'\');"><img src="/images/list.png" width="25px" height="25px" alt="Состав"></a>';
echo "</td>";
echo "<td>";
echo '<a href="javascript:editprodukt(\''.$Row['PRODUKT'].'\',\''.$Row['KATEGORIYA'].'\',\''.$Row['CENA'].'\',\''.$Row['ID'].'\',\''.$Row['ID_SOSTAV'].'\');" ><img src="/images/pen.png" width="25px" height="25px" alt=""></a>';
echo "</td>";
echo "<td>";
echo '<a href=# onclick="javascript:del_tovar(\''.$Row['ID'].'\');return(false);"> <img src="/images/error.png" width="25px" height="25px" alt="Удалить"> </a>';
echo "</td>";
echo "</tr>";
}
//echo '</table>';
...
document.body.style.overflow = 'hidden';
  $.ajax({
	type: "POST",
	url: "/sostav_produkcyy/getsostav.php",
