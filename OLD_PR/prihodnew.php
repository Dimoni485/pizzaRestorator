...
<th>Наименование</th><th>% утрат </th><th>Вес </th><th>Цена закупки</th><th>Чистый вес продукта</th><th>Цена с учетом утрат</th><th>Остаток товара на складе</th><th>Поставщик</th>
</tr>
</thead>
<?php
...
echo "<input type='text' id='procent_utrat".$Row['ID']."' onclick='javascript:selectinp('".$Row['ID']."');return(false);' onkeyup='javascript:viceslitves(\"".$Row['ID']."\");return(false);' value='".Round($procent_utrat,3)."' style='width:60px;border:none;'>%";
}else
{
echo "<input type='text' value='' id='procent_utrat".$Row['ID']."' onkeyup='javascript:viceslitves(\"".$Row['ID']."\");return(false);' style='width:60px;'>";
}
echo "</td>";
echo "<td>";
echo "<input type='text' id='ves".$Row['ID']."' onchange='javascript:savetovar(\"".$Row['ID']."\");return(false);' onkeyup='javascript:viceslitves(\"".$Row['ID']."\");return(false);' value='".$ves_tmp."' style='width:60px;'> <input type='text' id='edi_iz".$Row['ID']."' style='width:25px;border:0;'value='".$Row["ED_IZ"]."'>";
echo "</td>";
echo "<td>";
if (isset($cena_)){
echo "<input type='text' id='cena".$Row['ID']."' onchange='javascript:savetovar(\"".$Row['ID']."\");return(false);' onkeyup='javascript:viceslitves(\"".$Row['ID']."\");return(false);' value='".$cena_."' style='width:60px;'>р.";
}
else{
echo "<input type='text' id='cena".$Row['ID']."' value='' onchange='javascript:savetovar(\"".$Row['ID']."\");return(false);' onkeyup='javascript:viceslitves(\"".$Row['ID']."\");return(false);' style='width:60px;'>р.";
}
echo "</td>";
echo "<td>";
echo "<input type='text' onchange='javascript:savetovar(\"".$Row['ID']."\");return(false);' id='ves_cisto".$Row['ID']."' value='".Round($ves_netto,3)."' onkeyup='javascript:viceslit_proc(\"".$Row['ID']."\");return(false);' style='width:60px;'>кг.";
echo "</td>";
echo "<td>";
echo "<input type='text' onchange='javascript:savetovar(\"".$Row['ID']."\");return(false);' id='cena_s_utrata".$Row['ID']."' value='".Round($cene_brutto_tmp,3)."' style='width:60px;'>р.";
echo "</td>";
echo "<td>";
